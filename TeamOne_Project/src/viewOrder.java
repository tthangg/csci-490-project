...
public class viewOrder extends JFrame {
	...
	panelBuilderOrder3 orderInfoPanel;   // Panel for order information
	...
	public viewOrder()
	   {
	      ...
	      orderInfoPanel = new panelBuilderOrder3("View Order");
	   ...
	   private void buildListPanel()
	   {
	      try
	      {
	         ...
	         ResultSet orderInfo = orderTableManager.viewOrder("");
	      ...
	      public void actionPerformed(ActionEvent e)
	      {
	        // Get the order information from the text fields.
	            ...
	            try {
					...
					searchInfo = orderTableManager.viewOrder(status);
	      ...
	      public void actionPerformed(ActionEvent e)
	      {
	    	  ...
	    	  ResultSet searchInfo = null;
	            ...
	            try {
					...
					orderTableManager getInfo = new orderTableManager();
					//This creates a blank search of the table
					searchInfo = orderTableManager.viewOrder("");
	            } catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
