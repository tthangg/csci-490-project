...
public class insertInv extends JFrame{
	  
	
		panelBuilderInv invInfoPanel;   // Panel for emp information
		JPanel buttonPanel;                    // Panel for buttons	   
		   ...
		   public insertInv()
		   {
		      ...
		      invInfoPanel = new panelBuilderInv("Insert Employee");
		      ...
		      add(invInfoPanel, BorderLayout.CENTER);
...
;
		            ...
		            invTableManager invManager = new invTableManager();
		            
		            // Insert the record.
		            invManager.insert(item, quan, type);
		...
		// TODO Auto-generated method stub
			insertInv insertInv = new insertInv();
		}
